...
<div class="br-mainpanel">
    <div class="br-pagebody">
        ...
        <div class="br-section-wrapper" style="background-color: aliceblue;">
            <h6 class="br-section-label" style="padding: 10px;font-size:20px;">Student Profile</h6><br>
            <form action="{{ route('studentupdateProfile') }}"id="mainForm" method="POST" enctype="multipart/form-data">
                @csrf
                        ...
                        <div class="col-md-4">
                            <div class="box box-primary" style="background-color: #fff;">
                                <div class="box-body box-profile" style="text-align:center">
                                    <img onerror="this.onerror=null;this.src='{{asset('uploads/images/default.png')}}';" src="{{ asset('user-files/student/profile/'.$admin->code."/".$admin->profile_image) }}">
                                ...
                                <div class="tab-content">
                                    <div class="active tab-pane" id="profile">
                                        ...
                                        <dl class="row mb-0 pd-15">
                                            ...
                                            <div class="form-group col-md-8">
                                                <input class="form-control" type="text" value="{{$admin->middle_name}}" name="middle_name" id="middle_name" placeholder="Enter middle_name">
                                        ...
                                        <dl class="row mb-0">
                                            ...
                                            <div class="form-group col-md-8">
                                                <img src="{{ asset('user-files/student/profile/'.$admin->code."/".$admin->profile_image) }}" width="40" alt="">
