            ...
            <aside class="left-side sidebar-offcanvas">
                ...
                <section class="sidebar">
                    ...
                    <li id="dashboard-menu">
                     <a href="{{ route('parentshowDashboard') }}"><i class="fa icon-dashboardIcon"></i><span> Dashboard</span></a>
                    </li>
                    </ul>
                </section>
                <!-- /.sidebar -->
