...
<div class="box">
    <div class="box-header">
        <h3 class="box-title"><i class="fa fa-puzzle-piece"></i>Attend Exam </h3>
        <ol class="breadcrumb">
            <li><a href=""><i class="fa icon-dashboardIcon"></i> Dashboard</a></li>
            <li class="active">Attend Exam </li>
        </ol>
    </div><!-- /.box-header -->
    <!-- form start -->
    <div class="box-body">
                                    ...
                                    <tbody id=shedulelist>
                                        ...
                                        <tr>
                                            ...
                                            <td data-title="">
                                                ...
                                                <a href="{{route('teacherviewExam',['exam_id'=> $row->id])}}" class="btn btn-primary btn-sm" data-placement="top" data-toggle="tooltip" data-original-title="View">View</i>
