        ...
        <div class="row">
            ...
            <div class="col-sm-3">
                <div class="box box-primary">
                    ...
                    <img src="{{ asset('user-files/teacher/profile/'.$student->code."/".$student->profile_image) }}" onerror="this.onerror=null;this.src='{{asset('uploads/images/default.png')}}';" class="profile-user-img img-responsive img-circle" alt="">
