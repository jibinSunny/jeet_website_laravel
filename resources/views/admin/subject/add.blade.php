...
<div class="box">
    <div class="box-header">
        <h3 class="box-title"><i class="fa icon-subject"></i>Add Subject</h3>
             ...
             @csrf
                <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="subject_code" name="subject_code" value="{{ old('subject_code')}}"placeholder="Enter Subject Code">
                ...
                <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input type="number" class="form-control" id="pass_mark" name="pass_mark" value="{{ old('pass_mark')}}"placeholder="Enter Pass Mark">
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input type="number" class="form-control" id="total_mark" name="total_mark" value="{{ old('total_mark')}}"placeholder="Enter Total Mark">
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <textarea class="form-control" style="resize:none;" id="note" name="note"placeholder="Enter note">{{ old('note')}}</textarea>
                        </div>
                        <span class="col-sm-4 control-label"></span>
                    </div>
