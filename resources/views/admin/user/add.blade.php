...
<div class="box">
    <div class="box-header">
        <h3 class="box-title"><i class="fa icon-student"></i> Add User</h3>
        <ol class="breadcrumb">
                        ...
                        <fieldset class="wizard-fieldset show">
                            ...
                            <div class="col-lg-12 col-md-6 col-sm-6">
                                <div class="form-group pd-5">
                                    ...
                                    <option value="{{ $privilege1->id }}">{{ $privilege1->name}}</option>
                                    @endforeach
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control wizard-required" name="std_code" id="std_code" onchange="prevFunc(this,'std_code_op')">
                                            ...
                                            <option value="{{$countriess->phonecode}}">{{$countriess->phonecode}}</option>
                                           @endforeach
                                        </select>
                                        <div class="wizard-form-error"></div>
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-lg-4 col-md-4 col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control wizard-required" name="std_code2" id="std_code2" onchange="prevFunc(this,'std_code2_op')">
                                            <option value="">Select Code</option>
                                            @foreach($countries as $countriess)
                                            <option value="{{$countriess->phonecode}}">{{$countriess->phonecode}}</option>
                                            @endforeach
                                ...
                                <div class="col-lg-8 col-md-8 col-sm-8">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control wizard-required" id="phone2" name="phone2" placeholder="Enter Secondary Phone Number" onchange="prevFunc(this,'phone2_op')">
                                        <div class="wizard-form-error"></div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-md-6 col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control wizard-required" id="taluk" name="taluk" placeholder="Enter Taluk" onchange="prevFunc(this,'taluk_op')">
                                        <div class="wizard-form-error"></div>
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6 col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control wizard-required" id="village" name="village" placeholder="Enter Village" onchange="prevFunc(this,'village_op')">
                                        <div class="wizard-form-error"></div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6">
                                    ...
                                    <div class="form-group">
                                        <select name="user_type" id="user_type" class="form-control">
                                            ...
                                            <option value="{{$designations->id}}"@if($designations->id=="1" ||$designations->id=="2" ) disabled @endif>{{$designations->name}}</option>
                                            @endforeach
                                        </select>
                                        <div class="wizard-form-error"></div>
                                    </div>
                        ...
                        <fieldset class="wizard-fieldset">
                           ...
                           <div class="row">
                            ...
                            <div class="row">
                                <div class="col-lg-4 col-md-4 col-sm-4">
                                    <div class="form-group">
                                        <select name="id_type_op" id="id_type_op" class="form-control" onchange="prevFunc(this,'id_type_op')" disabled>
                                            <option value="">Select ID Card</option>
                                            <option>Adhaar</option>
                                            <option>Driving liecense</option>
                                            <option>Voter ID</option>
