...
<div class="box-header">
        <h3 class="box-title"> Edit Religions</h3>
            ...
            <form class="form-horizontal"id="mainForm" method="post" action="{{ route('saveReligion') }}" enctype="multipart/form-data">
             @csrf
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                        <input type="hidden" class="form-control" id="title" name="academicyear_id" value="{{$religionlist->id}}">
                            <input type="text" class="form-control" id="title" name="name" value="{{$religionlist->name}}"placeholder="Enter Name">
                        </div>
