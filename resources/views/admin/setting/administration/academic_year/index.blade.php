...
<div class="box">
    <div class="box-header">
        <h3 class="box-title"><i class="fa fa-sitemap"></i> Academic Year</h3>
                    ...
                    <table id="example1" class="table table-striped table-bordered table-hover dataTable no-footer">
                        <thead>
                            <tr>
                                ...
                                <th class="col-lg-2">Year Title</th>
                                <th class="col-lg-3">Starting Date</th>
                                <th class="col-lg-2">Ending Date</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td data-title="">{{ $row->start_date }}</td>
                                <td data-title="">{{ $row->end_date }}</td>
                                <td data-title="Action">
                                    <a href="{{route('editAcademicYear',['categoryId'=> $row->id])}}" class="btn btn-warning btn-xs mrg" data-placement="top" data-toggle="tooltip" data-original-title="Edit">Edit
            ...
            buttons: {
                deleteUser: {
                    ...
                    action: function() {
                        $.ajax({
                            type: "GET",
                            url: "{{url('admin/setting/administrator/academic-year/delete')}}?categoryId=" + categoryId,
