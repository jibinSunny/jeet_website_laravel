...
<div class="box">
    <div class="box-header">
        <h3 class="box-title"><i class="fa fa-sitemap"></i> Edit Academic Year</h3>
            ...
            <div class="col-sm-10">
                <form class="form-horizontal"id="mainForm" method="post" action="{{ route('saveAcademicYear') }}" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                        <input type="hidden" class="form-control" id="classes" name="academicyear_id" value="{{$academicyear->id}}">
                            <input type="number" class="form-control" id="classes" name="name" value="{{$academicyear->name}}">
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="classes_numeric" name="title" value="{{$academicyear->title}}">
                        </div>
                        <span class="col-sm-4 control-label">
                        </span>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="date1" name="start_date" value="{{$academicyear->start_date}}">
                        </div>
                        <span class="col-sm-4 control-label">
                        </span>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="date2" name="end_date" value="{{$academicyear->end_date}}">
                        </div>
                        <span class="col-sm-4 control-label">
                        </span>
                    </div>
