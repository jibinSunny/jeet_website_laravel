...
<div class="box">
    <div class="box-header">
        <h3 class="box-title"><i class="fa fa-sitemap"></i> Edit Class</h3>
            ...
            <form class="form-horizontal"id="mainForm" method="post" action="{{ route('saveClasses') }}" enctype="multipart/form-data">
             @csrf
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                        <input type="hidden" class="form-control" id="academicyear_id" name="academicyear_id" value="{{$class_list->id}}">
                            <input type="text" class="form-control" id="name" name="name" value="{{$class_list->name}}">
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="name_numeric" name="name_numeric"
                                value="{{$class_list->name_numeric}}">
                        </div>
                        <span class="col-sm-4 control-label">
                        </span>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <textarea class="form-control" style="resize:none;" id="note" name="note">{{$class_list->note}}</textarea>
                        </div>
                        <span class="col-sm-4 control-label">
                        </span>
                    </div>
