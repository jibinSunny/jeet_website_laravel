...
<div class="box">
    <div class="box-header">
        <h3 class="box-title"><i class="fa icon-classreport"></i> Teacher Report</h3>

        <ol class="breadcrumb">
            <li><a href=""><i class="fa icon-dashboardIcon"></i> Dashbaord</a></li>
            <li class="active"> Teacher Report</li>
        </ol>
    </div><!-- /.box-header -->
    <!-- form start -->
    <div class="box-body">
        <div class="row">
            <form id='mainForm' method="POST" action="{{ route('teacherReport') }}">
              @csrf
                <div class="col-sm-12">
                ...
                <div class="col-sm-12">
                    <div id="hide-table">
                        <table id="example1" class="table table-striped table-bordered table-hover dataTable no-footer">
                         ...
                         @foreach($all_report_teachers as $item)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{route('viewTeacherReport',['code'=> $item->code])}}" class="btn btn-warning btn-xs mrg" >View</a>
                                    </tr>
                            @endforeach                         
