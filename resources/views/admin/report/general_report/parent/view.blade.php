            ...
            <div class="col-sm-4">
                <div class="box box-primary">
                    <div class="box-body box-profile">
                        ...
                        <img src="{{ asset('user-files/parent/profile/'.$teacher->code."/".$student->profile_image) }}" onerror="this.onerror=null;this.src='{{asset('uploads/images/default.png')}}';" class="profile-user-img img-responsive img-circle" alt="">
            ...
            <div class="col-sm-8">
                <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs">
                        <li class="active"><a href="#profile" data-toggle="tab">Parent Profile</a></li>
