...
<div class="box">
    <div class="box-header">
        <h3 class="box-title"><i class="fa icon-student"></i> User Teacher</h3>
        <ol class="breadcrumb">
            ...
            <div class="col-sm-3">
                <div class="box box-primary">
                    <div class="box-body box-profile">
                        ...
                        <img src="{{ asset('user-files/user/profile/'.$teacher->code."/".$teacher->profile_image) }}" onerror="this.onerror=null;this.src='{{asset('uploads/images/default.png')}}';" class="profile-user-img img-responsive img-circle" alt="">
                        <h3 class="profile-username text-center">{{ $teacher->first_name }} {{ $teacher->last_name }}</h3>
                        <p class="text-muted text-center">{{ isset($teacher->usertypename->name )?$teacher->usertypename->name:''}}</p>
