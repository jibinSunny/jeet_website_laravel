...
<div class="box">
    ...
    <div class="box-header bg-gray">
        <h3 class="box-title text-navy"><i class="fa fa-clipboard"></i> Attendance Report</h3>
    </div><!-- /.box-header -->
    <div id="printablediv">
        <div class="box-body">
            <div class="row">
            <div class="col-sm-12">
                    <div class="reportPage-header">
                        ...
                        <p class="title">Inilabs School Management System</p>
                        <p class="title-desc">Mtipur, Dhaka</p>
                        <p class="title-desc">Academic Year : 2020-2021</p></div>
                    </div>
                <div class="col-sm-12">
                    <div class="row">
                    <div class="col-sm-12">
                            <h5 class="pull-left">Class : Five</h5>
                                                            <h5 class="pull-right">Section : All Section</h5>
                                                    </div>
                    </div>
                </div>
                <div class="col-sm-12">
