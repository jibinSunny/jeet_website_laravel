...
<div class="row">
    ...
    <div class="box">
        <div class="box-header bg-gray">
            <h3 class="box-title text-navy"><i class="fa fa-clipboard"></i>Credit Report</h3>
        </div><!-- /.box-header -->
        <!-- form start -->
        <div id="printablediv">
            <div class="box-body">
                <div class="row">
                    <form action="{{ route('showCreditReport') }}" method="POST">
                    @csrf
                        <div class="col-sm-12">
                            <div class="col-lg-3 col-md-3 col-sm-3">
                                <div class="form-group">
                                    <div class="form-wizard-label">Credit Category</div>
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-3">
                                <div class="form-group mt-2">
                                    <div class="col-sm-offset-2 col-sm-8">
                                        ...
                                        <a href="{{ route('showCreditReport') }}" class="btn btn-warning">Reset</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-sm-12">
                        <div class="box box-solid " style="border: 1px #ccc solid; border-left: 2px black solid">
                            <div class="box-header bg-gray with-border">
                                <h3 class="box-title text-navy">Credit Report</h3>
                            </div>
                                        ...
                                        <tbody>
                                            @if(count($collection)>0)
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{ $item['amount'] }}</td>
                                                    <td>
                                                    <form class="form-horizontal"method="post" action="{{ route('viewCreditReport') }}" enctype="multipart/form-data">
                                                      @csrf
...
<script>
    ...
    $('#credit-report-menu').addClass('active');
</script>
@endsection
