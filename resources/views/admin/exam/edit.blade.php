...
<div class="box">
    <div class="box-header">
        <h3 class="box-title"><i class="fa fa-pencil"></i>Edit Exam</h3>
        <ol class="breadcrumb">
             ...
             @csrf
                <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input type="date" class="form-control" id="date_time" name="date_time" value="{{date('Y-m-d',strtotime($examlist->date_time))}}" placeholder="Enter Date" >
                        </div>
                        <span class="col-sm-4 control-label">
                        </span>
                    </div>
