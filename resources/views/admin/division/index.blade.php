...
<div class="box">
    <div class="box-header">
        <h3 class="box-title"><i class="fa fa-star"></i> Division</h3>
                    ...
                    <table id="example1" class="table table-striped table-bordered table-hover dataTable no-footer">
                        <thead>
                            <tr>
                                ...
                                <th class="col-lg-2">Capacity</th>
                                <th class="col-lg-2">Class Name</th>
                                <th class="col-lg-2">Teacher Name</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td data-title="">{{ $row->capacity}}</td>
                                <td data-title="">{{ isset($row->classname->name)?$row->classname->name:''}}</td>
                                <td data-title="">{{ isset($row->Tachername->first_name)?$row->Tachername->first_name:''}}</td>
                                <td data-title=""style="width:100px">{{ $row->note}}</td>
                                <td data-title="Action"style="width:100px">
                                    <a href="{{route('editDivision',['categoryId'=> $row->id])}}" class="btn btn-warning btn-xs mrg" data-placement="top" data-toggle="tooltip" data-original-title="Edit">Edit</i>
            ...
            buttons: {
                deleteUser: {
                    ...
                    action: function() {
                        $.ajax({
                            type: "GET",
                            url: "{{url('admin/division/delete')}}?categoryId=" + categoryId,
