...
<div class="box">
    <div class="box-header">
        <h3 class="box-title"><i class="fa fa-pencil"></i>Edit Event</h3>
        <ol class="breadcrumb">
            ...
            <form class="form-horizontal"id="mainForm" method="post" action="{{ route('saveEvent') }}" enctype="multipart/form-data">
             @csrf
                 <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="title" name="title" value="{{$event_list->title}}"placeholder="Enter Title" >
                            <input type="hidden" class="form-control" id="academicyear_id" name="academicyear_id" value="{{$event_list->id}}" >
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <textarea style="resize:none;" class="form-control" id="description" name="description" placeholder="Enter Description">{{$event_list->description}}</textarea>
                        </div>
                        <span class="col-sm-4 control-label">
                        </span>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input type="trext" class="form-control" id="date" name="date" value="{{$event_list->date}}" placeholder="Enter Date" >
                        </div>
                        <span class="col-sm-4 control-label">
                        </span>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input type="time" class="form-control" id="time" name="time" value="{{$event_list->time}}" placeholder="Enter Time" >
                        </div>
                        <span class="col-sm-4 control-label">
                        </span>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select name="type" id="type" class="form-control select2" tabindex="-1">
                                        ...
                                        @if($event_list->type =="0")
                                        <option value="0"selected>Common  For  All</option>
                    ...
                    <div class="form-group" id="classesDiv" style="display:none">
                        ...
                        <select name="class" id="class" class="form-control select2" tabindex="-1">
                                        ...
                                        <option value="{{ $row->id}}" {{$event_list->class ==$row->id ? 'selected' :''}}>{{ $row->name}} </option>
                                        @endforeach
                                        </select>
                        </div>
                        <span class="col-sm-4 control-label"></span>
                    ...
                    <div class="form-group" id="divisioDiv" style="display:none">
                        ...
                        <select name="division" id="division" class="form-control select2" tabindex="-1">
                                        ...
                                        <option value="{{ $row->id}}" {{$event_list->division ==$row->id ? 'selected' :''}}>{{ $row->name}} </option>
                                        @endforeach
                                        </select>
                        </div>
                        <span class="col-sm-4 control-label"></span>
...
<script type="text/javascript">
  var book = <?php print_r(json_encode($event_list)) ?>;
      if(book['type'] == "0")
       {
        $('#classesDiv').hide();
        $('#divisioDiv').hide();
