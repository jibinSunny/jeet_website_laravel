            ...
            <div class="col-sm-10">
                <form class="form-horizontal"id="mainForm" method="post" action="{{ route('saveQuestionBank') }}" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            <textarea style="resize:none;" class="form-control" id="summernote" name="question"></textarea>
                        </div>
                        <span class="col-sm-4 control-label">
                        </span>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            <textarea style="resize:none;" class="form-control" id="summernote1" name="explanation" ></textarea>
                        </div>
                        <span class="col-sm-4 control-label">
                        </span>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            <input type="text" class="form-control" id="hints" name="hints" value="" placeholder="Enter hints">
                        </div>
                        <span class="col-sm-4 control-label">
                        </span>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            <input type="number" class="form-control" id="mark" name="mark" value="" placeholder="Enter mark">
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    <div class="form-group" style="display:none" id="option">
                        <label for="classesID" class="col-sm-2 control-label">
...
<script>
    ...
    //             let k = 1
    //             for (var i = 0; i < optioncount; ++i) {
    //                 $("#optioninput").append('<div class="form-group"> <label for="exam" class="col-sm-2 control-label">options ' + k + '<span class="text-red"></span></label><div class="col-sm-7"><input type="text" class="form-control" id="hints" name="option[]" value="" placeholder="Enter option ' +  k + '"></div><span class="form-radio"><input type="radio" value="' + i + '" id="' + i + '" name="answer[]" class="custom-control-input"></span></div>');
    ...
    //             let k = 1
    //             for (var i = 0; i < optioncount; ++i) {
    //                 $("#optioninput").append('<div class="form-group"> <label for="exam" class="col-sm-2 control-label">options ' +  k + '<span class="text-red"></span></label><div class="col-sm-7"><input type="text" class="form-control" id="hints" name="option[]" value="" placeholder="Enter option ' +  k + '"></div> </div>');
    //                 k++
    //             }
    //         }
