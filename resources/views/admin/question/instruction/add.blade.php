...
<div class="box">
    <div class="box-header">
        <h3 class="box-title"><i class="fa fa-pencil"></i>Add Instruction</h3>
        <ol class="breadcrumb">
             ...
             @csrf
                <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            <textarea style="resize:none;" class="form-control" id="summernote" name="content" placeholder="Enter Content"></textarea>
                        </div>
                        <span class="col-sm-4 control-label">
                        </span>
                    </div>
