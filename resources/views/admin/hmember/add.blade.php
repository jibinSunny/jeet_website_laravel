            ...
            <div class="col-sm-10">
                <form class="form-horizontal"id="mainForm" method="post" action="{{ route('saveHostelMember') }}" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input type="number" class="form-control" id="hostel_balance" name="hostel_balance" value="" placeholder="Enter Hostel Balance">
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="join_date" name="join_date" value="" placeholder="Enter Join Date">
                        </div>
