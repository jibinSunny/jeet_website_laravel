        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="callout callout-danger">
                    <p><b>Note:</b> Edit your institute expense</p>
                </div>
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-3">
                            <div class="form-group">
                                ...
                                <div class="col-sm-12">
                                    <select name="expense_category" id="expense_category" class="form-control select2" tabindex="-1" required>
                                        <option value="">Select Category</option>
                                        @foreach($expense_categories as $item)
                                            <option value="{{ $item->id }}" @if($expense->expense_category == $item->id) selected @endif>{{ $item->name }}</option>
                                        @endforeach
                                    </select>
                                    <input type="hidden" value="{{ $expense->code }}" name="expense_code">
                                </div>
                        ...
                        <div class="col-xs-12 col-sm-3">
                            <div class="form-group">
                                ...
                                <div class="col-sm-12">
                                    <input type="text" class="form-control" id="date" name="date" placeholder="Choose Date" value="{{ date('d-m-Y',strtotime($expense->date)) }}" required>
                                </div>
                                <span class="col-sm-4 control-label">
                                </span>
                            </div>
                        ...
                        <div class="col-xs-12 col-sm-3">
                            <div class="form-group">
                                ...
                                <div class="col-sm-12">
                                   <input type="text" class="form-control" id="amount" name="amount" placeholder="Enter Amount" value="{{ $expense->amount }}" required>
                                </div>
                                <span class="col-sm-4 control-label">
                                </span>
                            </div>
                                    ...
                                    <div class="input-group image-preview">
                                        ...
                                        <span class="input-group-btn">
                                            ...
                                            <div class="btn btn-primary image-preview-input">
                                                ...
                                                <span class="image-preview-input-title">Change File</span>
                    ...
                    <div class="row mt-2">
                        <div class="col-sm-5">
                            <div class="row">
                                ...
                                <div class="col-sm-12">
                                    <textarea style="resize:none;" class="form-control" id="description" name="description" placeholder="Enter description">{{ $expense->descritpion }}</textarea>
                                </div>
