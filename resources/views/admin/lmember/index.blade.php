...
<div class="box">
    <div class="box-header">
        <h3 class="box-title"><i class="fa icon-member"></i> Library Member</h3>
        <ol class="breadcrumb">
            <li><a href="{{ route('showDashboard') }}"><i class="fa icon-dashboardIcon"></i> Dashboard</a></li>
            <li class="active">Library Member</li>
        </ol>
    </div><!-- /.box-header -->
    <!-- form start -->
    <div class="box-body">
                                        ...
                                        <tbody>
                                            @foreach($memberlist as $row)
                                                <tr>
                                                    ...
                                                    <td data-title="">{{$row->member_id}}</td>
                                                    <td data-title="">{{$row->student}}</td>
                                                    <td data-title="">{{$row->balance}}</td>
                                                    ...
                                                    <td data-title="Action">
                                                        ...
                                                        <a href="{{route('editLibrarymember',['categoryId'=> $row->id])}}" class="btn btn-warning btn-xs mrg" data-placement="top" data-toggle="tooltip" data-original-title="Edit">Edit</a>
            ...
            buttons: {
                deleteUser: {
                    ...
                    action: function() {
                        $.ajax({
                            type: "GET",
                            url: "{{url('admin/librarymember/delete')}}?categoryId=" + categoryId,
