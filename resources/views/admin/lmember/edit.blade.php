            ...
            <div class="col-sm-10">
                <form class="form-horizontal"id="mainForm" method="post" action="{{ route('saveLibrarymember') }}" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                        <input type="hidden" class="form-control" id="academicyear_id" name="academicyear_id" value="{{$memberlist->id}}" placeholder="Enter  Balance">
                            <input type="number" class="form-control" id="balance" name="balance" value="{{$memberlist->balance}}" placeholder="Enter  Balance">
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input type="date" class="form-control" id="join_date" name="join_date" value="{{$memberlist->join_date}}" placeholder="Enter Join Date">
                        </div>
                        <span class="col-sm-4 control-label">
                        </span>
                    </div>
