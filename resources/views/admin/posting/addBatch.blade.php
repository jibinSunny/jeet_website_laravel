    ...
    <div class="col-sm-3">
        <div class="box">
            <div class="box-header">
                <h3 class="box-title"><i class="fa icon-invoice"></i> Batch Posting</h3>
            </div><!-- /.box-header -->
            <div class="box-body">
                <form role="form" method="post" enctype="multipart/form-data" id="invoiceDataForm"> 
                    ...
                    <input id="addInvoiceButton" type="button" class="btn btn-success" value="Add Post" >
                </form>
            </div>
        </div>
    </div>
        ...
        <div class="box">
            <div class="box-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">Add Posting</li>
                </ol>
            </div><!-- /.box-header -->
            <div class="box-body">
                        ...
                        <div class="col-sm-12">
                            <div class="form-group" >
                                ...
                                <select name="class" id="class" class="form-control select2" tabindex="-1">
                                    ...
                                    <option value="0">Books Fine</option>
                                    <option value="0">Library Fee</option>
                                    <option value="0">Transport Fee</option>
                                    <option value="0">Hostel Fee</option>
                ...
                <div class="table-responsive">
                    <table class="table table-bordered feetype-style" style="font-size: 16px;">
                        ...
                        <tbody id="feetypeList">
                            <tr id="tr_6704180657537293" invoicefeetypeid="1"><td>1</td>
                                <td>Books Fine</td>
                                <td><input type="text" class="form-control change-amount" id="td_amount_id_6704180657537293" data-amount-id="6704180657537293"></td>
                                <td><input type="text" class="form-control change-quantity" value="1" id="td_quantity_3434" ></td>
                                <td><a style="margin-top:3px" href="#" class="btn btn-danger btn-sm deleteBtn" id="feetype_6704180657537293" data-feetype-id="6704180657537293">Delete</a></td>
                            </tr>
                            
                            <tr id="tr_6219135077847571" invoicefeetypeid="2">
                                <td>2</td>
                                <td>Library Fee</td>
                                <td><input type="text" class="form-control change-amount" id="td_amount_id_6219135077847571" data-amount-id="6219135077847571"></td>
                                <td><input type="text" class="form-control change-discount" value="1" id="td_quantity_4343"></td>
                                <td><a style="margin-top:3px" href="#" class="btn btn-danger btn-sm deleteBtn" id="feetype_6219135077847571" data-feetype-id="6219135077847571">Delete</a></td>
                            </tr>
                            
                            <tr id="tr_33602958012575" invoicefeetypeid="4">
                                <td>3</td><td>Hostel Fee</td>
                                <td><input type="text" class="form-control change-amount" id="td_amount_id_33602958012575" data-amount-id="33602958012575"></td>
                                <td><input type="text" class="form-control change-discount" id="td_quantity_5456">
                                <td><a style="margin-top:3px" href="#" class="btn btn-danger btn-sm deleteBtn" id="feetype_33602958012575" data-feetype-id="33602958012575">Delete</a></td>
                            </tr>
                        </tbody>
                        ...
                        <tfoot id="feetypeListFooter">
                            <tr>
                                ...
                                <td id="totalDiscount" style="font-weight: bold">1</td>
                                <td><a style="margin-top:3px" href="#" class="btn btn-danger btn-sm deleteBtn" id="feetype_5686041014361871" data-feetype-id="5686041014361871">Delete</a></td>
                            </tr>
                        </tfoot>
                    </table>
                </div>
