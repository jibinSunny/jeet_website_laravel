                    ...
                    <table id="example1" class="table table-striped table-bordered table-hover dataTable no-footer">
                        ...
                        @foreach($leaveapply_list as $row)
                                <tr>
                                    ...
                                    <a href="{{route('editleaveApply',['categoryId'=> $row->id])}}" class="btn btn-warning btn-xs mrg" data-placement="top" data-toggle="tooltip" data-original-title="Edit">Edit</a>
            ...
            buttons: {
                deleteUser: {
                    ...
                    action: function() {
                        $.ajax({
                            type: "GET",
                            url: "{{url('admin/leaveapply/delete')}}?categoryId=" + categoryId,
