...
<div class="box">
    <div class="box-header">
        <h3 class="box-title"><i class="fa icon-routine"></i>Add Time Table</h3>
            ...
            <form class="form-horizontal"id="mainForm" method="post" action="{{ route('saveTimeTable') }}" enctype="multipart/form-data">
             @csrf
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <select name="year" id="year" class="form-control select2" tabindex="-1">
                                ...
                                <option value="{{$academicyears->id}}">{{$academicyears->name}}</option>
                                @endforeach
                            </select>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="starttime" name="start_time" value="" >
                        </div>
                        <span class="col-sm-4 control-label">
                        </span>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="endtime" name="end_time" value="" >
                        </div>
                        <span class="col-sm-4 control-label">
                        </span>
                    </div>
