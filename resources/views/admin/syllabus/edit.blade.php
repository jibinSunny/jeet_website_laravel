            ...
            <form class="form-horizontal"id="mainForm" method="post" action="{{ route('saveSyllabus') }}" enctype="multipart/form-data">
             @csrf
              <div class="form-group">
                        ...
                        <div class="col-sm-6">
                        <input type="hidden" class="form-control" id="academicyear_id" name="academicyear_id" value="{{$syllabus_list->id}}" placeholder="Enter Name">
                            <input type="text" class="form-control" id="name" name="name" value="{{$syllabus_list->name}}" placeholder="Enter Name">
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <select name="class" id="class" class="form-control select2" tabindex="-1">
                                ...
                                <option value="{{ $classes->id}}" {{$syllabus_list->class ==$classes->id ? 'selected' :''}}>{{ $classes->name}} </option>
                                @endforeach
                            </select>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <select name="academic_year" id="academic_year" class="form-control select2" tabindex="-1">
                                ...
                                <option value="{{ $academic_year->id}}" {{$syllabus_list->academic_year ==$academic_year->id ? 'selected' :''}}>{{ $academic_year->name}} </option>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <textarea class="form-control" style="resize:none;" id="description" name="description">{{$syllabus_list->description}}</textarea>
                        </div>
                        <span class="col-sm-4 control-label">
