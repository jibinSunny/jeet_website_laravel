            ...
            <form class="form-horizontal"id="mainForm" method="post" action="{{ route('saveexamSchedule') }}" enctype="multipart/form-data">
             @csrf
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="edate" name="edate" value=""placeholder="Enter Exam Date" >
                        </div>
                        <span class="col-sm-4 control-label">
                        </span>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input type="time" class="form-control" id="examfrom" name="examfrom" value="" >
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input type="time" class="form-control" id="examto" name="examto" value="" >
                        </div>
                        <span class="col-sm-4 control-label">
