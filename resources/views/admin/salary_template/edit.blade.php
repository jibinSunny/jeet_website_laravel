...
<div class="box">
    <div class="box-header">
        <h3 class="box-title"><i class="fa fa-calculator "></i> </h3>
        <ol class="breadcrumb">
        ...
        <form class="form-horizontal" role="form" method="post" id="templateDataForm">
            <div class="row">
                <div class="col-sm-12" style="margin-bottom: 10px;">
                        ...
                        <span class="col-sm-4 control-label" id="salary_grades_error"></span>
                    </div>
                        ...
                        <span class="col-sm-4 control-label" id="basic_salary_error"></span>
                    </div>
                            ...
                            <div class="row">
                                <div class="col-sm-12" id="allowances">
                                                <div class='form-group allowancesfield'>
                                                    ...
                                                    <div class="col-sm-5">
                                                        <input type="text" class="form-control allowancesamount" id="" name="" value="" placeholder="">
                                                    </div>

                                                    <div class="col-sm-2" >
                                                            <button type="button" class="btn btn-success btn-xs salary-btn salary-btn-allowances-add ml-1" id="salary-btn-allowances-add" onclick="addAllowances()">
                                                                <i class="fa fa-plus"></i>
                                                            </button>
                                                            <button id="" class="btn btn-danger btn-xs salary-btn salary-btn-allowances-remove mr-1" type="button" onclick="removeAllowances(this)">
                                                    ...
                                                    <span class="col-sm-12 errorpointallowances" id="">
                                                    </span>
                                                </div>
                                        <div class='form-group allowancesfield'>
                                            <div class="col-sm-5">
                                            ...
                                            <div class="col-sm-5">
                                                <input type="text" class="form-control allowancesamount" id="allowancesamount1" name="allowancesamount1" value="" placeholder="">
                                            </div>
                            ...
                            <div class="row">
                                <div class="col-sm-12" id="deductions">
                                                ...
                                                <div class='form-group deductionsfield'>
                                                    ...
                                                    <div class="col-sm-5">
                                                        <input type="text" class="form-control deductionsamount" id="" name="" value="" placeholder="">
                                                    </div>
                                                    ...
                                                    <div class="col-sm-2" >
                                                            ...
                                                            <button id="" type="button" class="btn btn-danger btn-xs salary-btn salary-btn-deductions-remove" onclick="removeDeductions(this)">
                                                                <i class="fa fa-trash"></i>
                                                            </button>
                                                    ...
                                                    <span class="col-sm-12 errorpointdeductions" id="">
                                                    </span>
                                                </div>
                                        <div class='form-group deductionsfield'>
                                            <div class="col-sm-5">
                                            ...
                                            <div class="col-sm-5">
                                                <input type="text" class="form-control deductionsamount" id="deductionsamount1" name="deductionsamount1" value="" placeholder="">
                                            </div>
                                ...
                                <div class="col-sm-12">
                                    <table class="table table-bordered">
                                        <tr>
                                            ...
                                            <td class="col-sm-4"><input class="form-control" id="gross_salary" type="text" value="" disabled="disabled" name="gross_salary"></td>
                                        </tr>

                                        <tr>
                                            <td class="col-sm-8" style="line-height: 36px"></td>

                                            <td class="col-sm-4"><input class="form-control" id="total_deduction" type="text" value="" disabled="disabled" name="total_deduction"></td>
                                        </tr>

                                        <tr>
                                            <td class="col-sm-8" style="line-height: 36px"></td>

                                            <td class="col-sm-4"><input class="form-control" id="net_salary" type="text" value="" disabled="disabled" name="net_salary"></td>
                                        </tr>
                                    </table>
                                </div>
                            </div>
                ...
                <div class="col-sm-12 col-xs-12">
                    <input class="btn btn-success pull-right col-sm-3 col-xs-12 " type="button" id="addSalaryTemplate" value="">
                </div>
