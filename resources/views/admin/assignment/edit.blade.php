...
<div class="box-header">
        <h3 class="box-title"><i class="fa icon-assignment"></i> Edit Assignment</h3>
            ...
            <form class="form-horizontal"id="mainForm" method="post" action="{{ route('saveAssignment') }}" enctype="multipart/form-data">
             @csrf
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                          <input type="hidden" class="form-control" id="academicyear_id" name="academicyear_id" value="{{$assignmentlist->id}}"placeholder="Enter Name">
                            <input type="text" class="form-control" id="title" name="name" value="{{$assignmentlist->name}}"placeholder="Enter Name">
                        </div>
                    ...
                    <label for="title" class="col-sm-2 control-label">
                      Category<span class="text-red">*</span>
                        ...
                        <option value="{{$row['value']}}"{{$assignmentlist->category ==$row['value'] ? 'selected' :''}}>{{$row['name']}}</option>
                        @endforeach
                        </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input type="date" class="form-control" id="deadline_date" name="deadline_date" value="{{date('Y-m-d',strtotime($assignmentlist->deadline_date))}}"placeholder="Enter Deadline">
                        </div>
                        <span class="col-sm-4 control-label"></span>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <select name="class" id="class" class="form-control select2" tabindex="-1">
                                ...
                                <option value="{{ $class->id}}" {{$assignmentlist->class ==$class->id ? 'selected' :''}}>{{ $class->name}} </option>
                                @endforeach
                            </select>
                        </div>
                        <span class="col-sm-4 control-label"></span>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <select name="subject" id="subject" class="form-control select2" tabindex="-1">
                                ...
                                <option value="{{ $subjects->id}}" {{$assignmentlist->subject ==$subjects->id ? 'selected' :''}}>{{ $subjects->name}} </option>
                                @endforeach
                            </select>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <select name="division" id="division" class="form-control select2" tabindex="-1">
                                ...
                                <option value="{{ $divisions->id}}" {{$assignmentlist->division ==$divisions->id ? 'selected' :''}}>{{ $divisions->name}} </option>
                                @endforeach
                            </select>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <select name="academic_year" id="academic_year" class="form-control select2" tabindex="-1">
                                ...
                                <option value="{{ $academic_years->id}}" {{$assignmentlist->academic_year ==$academic_years->id ? 'selected' :''}}>{{ $academic_years->name}} </option>
                                @endforeach
                            </select>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <textarea class="form-control" style="resize:none;" id="description"
                                name="description"placeholder="Enter Description"> {{$assignmentlist->description}}</textarea>
                        </div>
                        <span class="col-sm-4 control-label"></span>
                    </div>
                    <div class="form-group">
