...
<div class="box">
    <div class="box-header">
        <h3 class="box-title"><i class="fa icon-issue"></i>Edit Issue</h3>
            ...
            <div class="col-sm-10">
                <form class="form-horizontal" id="mainForm" method="post" action="{{ route('saveBookissue') }}" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input type="hidden" class="form-control" id="academicyear_id" name="academicyear_id" value="{{$bookIssue->id}}" placeholder="Enter Seriel No">
                            <input type="text" class="form-control" id="seriel_no" name="seriel_no" value="{{$bookIssue->seriel_no}}" placeholder="Enter Seriel No">
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <select name="user_type" id="user_type" class="form-control select2" tabindex="-1">
                                ...
                                <option value="{{ $row->id}}" {{$bookIssue->user_type ==$row->id ? 'selected' :''}}>{{ $row->name}} </option>
                                @endif
                                @endforeach
                            </select>
                        </div>
                    ...
                    <div class="form-group" >
                        ...
                        <div class="col-sm-6">
                            <select name="library_member" id="user" class="form-control select2" tabindex="-1">
                                ...
                                <option value="{{$bookIssue->user_name['id']}}"selected>{{$bookIssue->user_name['first_name']}}</option>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <select name="class" id="class" class="form-control select2" tabindex="-1">
                                    ...
                                    <option value="{{ $class->id}}" {{$bookIssue->class ==$class->id ? 'selected' :''}}>{{ $class->name}} </option>
                                    @endforeach
                                </select>
                            </div>
                            <span class="col-sm-4 control-label"></span>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <select name="division" id="division" class="form-control select2" tabindex="-1">
                                    ...
                                    <option value=" {{ isset($bookIssue->divisionname->id )?$bookIssue->divisionname->name :''}}"selected> {{ isset($bookIssue->divisionname->name )?$bookIssue->divisionname->name :''}} </option>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <select name="book" id="bloodgroup" class="form-control select2" tabindex="-1">
                                ...
                                <option value="{{ $books->id}}" {{$bookIssue->book ==$books->id ? 'selected' :''}}>{{ $books->name}} </option>
                                @endforeach
                            </select>
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input type="date" class="form-control" id="due_date" name="due_date" value="{{date('Y-m-d',strtotime($bookIssue->due_date))}}">
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input type="date" class="form-control" id="issued_date" name="issued_date" value="{{date('Y-m-d',strtotime($bookIssue->issued_date))}}">
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input type="date" class="form-control" id="return_date" name="return_date" value="{{date('Y-m-d',strtotime($bookIssue->return_date))}}">
                        </div>
                        <span class="col-sm-4 control-label">
...
<script type="text/javascript">
  var book = <?php print_r(json_encode($bookIssue)) ?>;
      if(book['user_type'] == "3")
       {
        $('#class_id').show();
       }
