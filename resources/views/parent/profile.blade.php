...
<div class="br-mainpanel">
    <div class="br-pagebody">
        ...
        <div class="br-section-wrapper" style="background-color: aliceblue;">
            <h6 class="br-section-label" style="padding: 10px;font-size:20px;">Parent Profile</h6><br>
            <form action="{{ route('parentupdateProfile') }}"id="mainForm" method="POST" enctype="multipart/form-data">
                @csrf
                        ...
                        <div class="col-md-4">
                            <div class="box box-primary" style="background-color: #fff;">
                                <div class="box-body box-profile" style="text-align:center">
                                    <img onerror="this.onerror=null;this.src='{{asset('uploads/images/default.png')}}';" src="{{ asset('user-files/parent/profile/'.$admin->code."/".$admin->photo	) }}">
                                ...
                                <div class="tab-content">
                                    <div class="active tab-pane" id="profile">
                                        ...
                                        <dl class="row mb-0">
                                            ...
                                            <div class="form-group col-md-8">
                                                <img src="{{ asset('user-files/parent/profile/'.$admin->code."/".$admin->photo	) }}" width="40" alt="">
